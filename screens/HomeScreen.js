...
/* note that we import text from react-native-paper instead of react native */
/* react native paper is like a ui template for android */
import { Card, Text, Button, List, IconButton } from "react-native-paper";

const HomeScreen = () => {
  return ( /* notice that everything is wrapped in a scrollview! (allows u to scroll instead of the normal view which doesnt) */
    <ScrollView style={styles.container}>
      <Card style={styles.card}>
        ...
        />
        <Card.Content>
          /* variants ensure standardised text size without having to set the same thing over and over again */
          /* comes from react native paper */
      ...
      <Card style={[styles.card, styles.outlinedCard]}>
        <Card.Content>
          ...
          <List.Item
            ...
            left={() => <List.Icon icon="trophy" />} /* places icons on the left */
          />
          <List.Item
      ...
      <Card style={[styles.card, styles.interactiveCard]}>
        <Card.Content>
          ...
          <List.AccordionGroup> /* looks similar to drop down lists (can be used for faq) */
            <List.Accordion
              id="faq1"
